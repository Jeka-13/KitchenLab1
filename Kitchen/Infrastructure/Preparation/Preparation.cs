...
namespace Kitchen.Infrastructure.Preparation
{
    public class Preparation
    {
        ...
        public static void PrepareCookingApparatus(List<CookingApparatus> apparatuses)
        {
        ...
        public static void PrepareCooks(List<Cook> cooks)
        {
